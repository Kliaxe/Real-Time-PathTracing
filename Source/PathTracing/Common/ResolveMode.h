...
{
  // Upper bound on REBLUR's temporal history length, in frames.
  ...
  // Radius of REBLUR's diffuse pre-pass blur, in pixels.
  float    diffusePrepassBlurRadius = 30.0f;
  // Radius of REBLUR's specular pre-pass blur, in pixels.
